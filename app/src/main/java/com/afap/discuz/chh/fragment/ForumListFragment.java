...
public class ForumListFragment extends BaseListFragment {
    ...
    protected void showHistory() {
        ...
        qb.where(CategoryListAtomDao.Properties.Cat.eq("forum-" + mCategory.getId()));
        ...
        Network
                ...
                .subscribe(new Observer<String>() {
                    ...
                    public void onNext(String s) {
                        ...
                        List<CategoryListAtom> list = CategoryListAtom.parseFromElements(doc, "forum-" + mCategory.getId());
                        mAdapterList.addAll(list);
